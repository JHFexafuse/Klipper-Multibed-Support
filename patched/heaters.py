...
class Heater:
    ...
    def cmd_SET_HEATER_TEMPERATURE(self, gcmd):
        ...
        # Wenn dies heater_bed ist: synchronisiere andere Betten
        if self.name == "heater_bed":
            for name in ["_Bed_2", "_Bed_3", "_Bed_4", "_Bed_5", "_Bed_6", "_Bed_7", "_Bed_8", "_Bed_9"]:
                try:
                    h = pheaters.lookup_heater(name)
                    pheaters.set_temperature(h, temp)
                except Exception:
